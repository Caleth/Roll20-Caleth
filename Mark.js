...
var Mark = Mark || (function() {
    ...
    var version = 0.22,
        ...
        aegisURL = 'https://s3.amazonaws.com/files.d20.io/images/5989340/NTitGWnXmIyPntMCK2losg/thumb.png?1413588277',
...
+'</div>'
    ...
    HandleInput = function(msg) {
        ...
        switch(args[0]) {
            ...
            case '!mark':
                addMark(args, who, msg, markerURL);
                break;
    ...
    addMark = function(args, who, msg, URL) {
        var 
            errors=[],
            playerPage,
            markerSupply,
